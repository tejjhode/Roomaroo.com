...
function MyList({ $id, tittle, price, size, bhk, location, type, furnished, bathroom, image }) {
  return (
    <Link to={`/post/${$id}`}>
      <div className="bg-white h-40 w-3/4 rounded-2xl flex shadow-2xl shadow-black mt-6">
        {image && (
          <img
